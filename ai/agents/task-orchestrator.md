...
2. unit-test-writer → Add tests for critical paths
...
2. Developer implements Stage 1
3. unit-test-writer → Add tests for Stage 1
...
| New feature, clear requirements   | implementation-planner → code-reviewer → unit-test-writer  | Sequential  |
